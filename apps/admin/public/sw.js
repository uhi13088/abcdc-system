/**
 * Service Worker for PEANOTE Admin App
 * - 푸시 알림 수신
 * - 알림 클릭 처리
 */

const CACHE_NAME = 'peanote-admin-v1';
...
self.addEventListener('push', (event) => {
  ...
  // 긴급 알림 처리
  if (data.category === 'EMERGENCY' || data.priority === 'HIGH') {
...
self.addEventListener('notificationclose', (event) => {
  console.log('[Admin SW] Notification closed');
});
