...
INSERT INTO ccp_definitions_template (ccp_code, process_name, lower_limit, upper_limit, unit, monitoring_frequency, sort_order) VALUES
  ...
  -- CCP-4B: 세척원료
  ('CCP-4B-WASH-VOL', '세척원료-세척수량(ℓ)', 3, 9999, 'L', '매작업시', 15),
  ('CCP-4B-WASH-TIME', '세척원료-세척시간(분)', 5, 9999, '분', '매작업시', 16),

  -- CCP-5P: 금속검출
  ('CCP-5P-PIECE-FE20', '금속검출-테스트피스 Fe2.0mm 통과', 1, 1, 'Bool', '작업시작/2시간/변경/종료', 17),
  ('CCP-5P-PIECE-SUS25', '금속검출-테스트피스 SUS2.5mm 통과', 1, 1, 'Bool', '작업시작/2시간/변경/종료', 18),
  ('CCP-5P-PROD', '금속검출-제품 불검출', 1, 1, 'Bool', '상시', 19);
